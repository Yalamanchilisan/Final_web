...
export const AdoptingPets = () => {
  ...
  return (
   <div style={{background:"#446879", paddingTop:"50px"}} className="about-container">
    ...
    <h1 style={{ textAlign:"left", marginLeft:"10%", fontSize:"40px", color:"#446879" }}>Adopting Pets</h1>
  ...
  <Box textAlign="left" ml="7%" fontFamily={"Cairo, sans-serif"}  >
    <p>
    You've probably witnessed it in movies – on Christmas morning, excited little Suzy discovers her new puppy nestled under the tree, adorned with a festive bow around its neck. Suzy's eyes light up with joy as she rushes to embrace her new furry friend, who eagerly returns the affection with a playful lick on the cheek. From that moment on, Suzy and her new companion embark on a journey of friendship and endless adventures together.
    <br />
...
<Button size="lg" onClick={handleToggle} mt="1rem" border={"2px solid #6504b5"} color={"#6504b5"}  colorScheme='purpule' variant='outline' marginLeft="20px">
  Learn {show ? "Less" : "More"}
       ...
       <Button size="lg" borderRadius="20" mt="1rem" bg={'#dba529'} colorScheme='purpule' w="300px" >GET STARTED</Button>
       </div>
    </div>
<div>
...
<div style={{display:"grid", gridTemplateColumns:"repeat(3, 1fr)", width:"60%", textAlign:"left", marginLeft:"7%"}}>
    ...
    <div style={{width:"100%", marginLeft:"20px", padding:"10px", background:"white", borderRadius:"15px"}}>
            ...
            <Button size="lg" borderRadius="20" mt="1rem" bg={'#dba529'} colorScheme='purpule' w="300px" >SEARCH</Button>
        </div>
        <br />
         <div style={{width:"100%", marginLeft:"20px", padding:"30px", background:"white", borderRadius:"15px"}}>
